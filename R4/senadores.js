...
console.log(width_sen, height_sen)
...
queue()
    ...
    .await(
        function(error, dataFromCSV_sen) {
            ...
            console.log("height_sen", height_sen);
            //var FUERZAS = {};
            'use strict';
            ...
            //         }
            //     }),
            //     width_sen = parseFloat(svg_sen.attr("width_sen")),
            //     height_sen = parseFloat(svg_sen.attr("height_sen"));
...
// (function() { // (function(){usted esta aquí})()
//     console.log("ok");
...
//             var currentWidth = this.parentElement.clientWidth
//             console.log("2");
//             return parseFloat(currentWidth * (parseFloat(height_sen) / parseFloat(width_sen)));

//         })
//     });
//     console.log(svg_sen);
// })(// (function(){})( usted esta aquí)
//     //Request con d3
...
//         var height_sen = height_sen || 250;
//         var width_sen = width_sen || 480;
...
//             .attr("width", width_sen)
//             .attr("height", height_sen)
//             .attr("viewBox", "0 0" +" "+ width_sen +" "+ height_sen)
//             .attr("id", "hemi_sen")
